...
class TestOpenStackOVSODLCharm(Helper):
    ...
    def test_odl_register_macs(self):
        ...
        self.patch(openvswitch_odl.socket, 'gethostname')
        self.patch(openvswitch_odl.ODL, 'ODLConfig')
        self.patch(openvswitch_odl.PCIDev, 'PCIInfo')
        self.ODLConfig.return_value = odl
        self.gethostname.return_value = 'ovs-host'
...
class TestOpenStackOVSODL(Helper):

    def test_install(self):
        self.patch(openvswitch_odl.OVSODLCharm.singleton, 'install')
        openvswitch_odl.install()
        self.install.assert_called_once_with()

    def test_configure_openvswitch(self):
        odl_ovsdb = mock.MagicMock()
        self.patch(openvswitch_odl.OVSODLCharm.singleton,
                   'configure_openvswitch')
        openvswitch_odl.configure_openvswitch(odl_ovsdb)
    ...
    def test_unconfigure_openvswitch(self):
        ...
        openvswitch_odl.unconfigure_openvswitch(odl_ovsdb)
    ...
    def test_configure_plugin(self):
        ...
        openvswitch_odl.configure_plugin(neutron_plugin)
        self.configure_neutron_plugin.assert_called_once_with(neutron_plugin)

    def test_register_node(self):
        controller = mock.MagicMock()
        self.patch(openvswitch_odl.OVSODLCharm.singleton,
                   'odl_node_registration')
        openvswitch_odl.register_node(controller)
        self.odl_node_registration.assert_called_once_with(controller)

    def test_register_macs(self):
        controller = mock.MagicMock()
        self.patch(openvswitch_odl.OVSODLCharm.singleton, 'odl_register_macs')
        openvswitch_odl.register_macs(controller)
        self.odl_register_macs.assert_called_once_with(controller)
